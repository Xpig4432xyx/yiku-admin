...
class ArticleCreate extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      state: false, // 文章发布状态 => false 草稿，true 已发布
    ...
    return (
      <div>
        ...
        >
          ...
          <Select.Option value="1">技术分享</Select.Option>
          <Select.Option value="2">生活随记</Select.Option>
          <Select.Option value="3">简历</Select.Option>
        </Select>
